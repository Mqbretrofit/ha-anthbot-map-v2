...
class AnthbotBatterySaverSwitchEntity(
    ...
    def extra_state_attributes(self) -> dict[str, object]:
        ...
        due_at = self.coordinator.battery_saver_shutdown_guard_due_at
        ...
        return {
            **config,
            ...
            "shutdown_guard_remaining_seconds": (
                self.coordinator.battery_saver_shutdown_guard_remaining_seconds
            ),
            "shutdown_guard_due_at": due_at,
            "shutdown_guard_pulse_until": pulse_until,
        }
