...
"""
    ...
    def test_ui_separates_path_alignment_from_robot_direction(self) -> None:
        ...
        self.assertIn('dpad("data-robot-calibration")', card)
        self.assertIn('dpad("data-mowing-path-calibration")', card)
        self.assertIn('tools("data-mowing-path-calibration", "reset-mowing-path")', card)
