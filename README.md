...
[![Release](https://img.shields.io/badge/release-v2.4.9.2-beta.1-blue)](https://github.com/Mqbretrofit/ha-anthbot-map-v2/releases/tag/v2.4.9.2-beta.1)
...
Stable version: **2.4.9.2-beta.1**

Latest release: [Anthbot Map v2.4.9.2-beta.1](https://github.com/Mqbretrofit/ha-anthbot-map-v2/releases/tag/v2.4.9.2-beta.1)
